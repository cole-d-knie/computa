---
name: computa-swarm-verify-tdd-qa
description: "Apply test-driven development and runtime QA for computa-swarm-verified work: failing tests before implementation, minimal modular fixes or builds, passing tests after, edge cases, unit/integration/smoke checks, live API or UI verification, and Playwright for browser-visible behavior."
---
