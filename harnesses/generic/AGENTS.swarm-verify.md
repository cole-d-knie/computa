...
3. Run Phase 1 orientation audit before implementation: create `maps/map-index.md`, `task-scope-map.md`, `codebase-map.md`, `flow-map.md`, `test-and-command-map.md`, and `risk-map.md`.
...
10. Keep ledgers and maps current. Mark items done only after evidence exists.
11. Create final Markdown reports for summary, verification still needed, blockers/open issues, original-task gap analysis, map artifacts used/updated, and new issues found split fixed vs not fixed.
